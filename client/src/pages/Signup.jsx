  ...
  return (
    <div className="home-login-signup-w-h grid relative place-content-center">
      <SignupForm 
        ...
        setIsPassingPwd={setIsPassingPwd}
        isPassingPwd={isPassingPwd}
        setPwdNotMatchingCriteria={setPwdNotMatchingCriteria}
        pwdNotMatchingCriteria={pwdNotMatchingCriteria} 
        error={error} 
        isLoading={isLoading} 
        formRef={formRef}/>
    </div>
