  ...
  return (
      <div className="h-screen relative grid justify-center place-content-center text-slate-800">
        <div className="max-w-[600px]">
          ...
          <p className="animate-delayed fadeInUp3 px-4 md:text-xl font-extralightlight text-center mb-5"><span className="font-bold">Sketchr</span> is your online art journal meant to help you form the habit of drawing consistently and looking back at your progress.</p>
