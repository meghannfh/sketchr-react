  ...
  return (
      <div className="h-screen relative grid justify-center place-content-center text-slate-800">
        <div className="max-w-[600px]">
          ...
          <p className="animate-delayed fadeInUp3 px-4 text-center mb-5"><span className="font-bold text-lg text-pink-500">Mindstroke</span> is your online art journal meant to help you form the habit of drawing consistently and looking back at your progress.</p>
          <h3 className="animate-delayed fadeInUp4 text-lg text-center font-semibold">No pressure. No obligations. No distractions.</h3>
        </div>
